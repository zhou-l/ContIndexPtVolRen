...
pcaList = zeros(OT.BinCount,(nVols+1)*nVols);
...
%         if  pos(1) < 1+padDimFirstHalf(1) || pos(2) < 1+padDimFirstHalf(2) || pos(3) < 1+padDimFirstHalf(3)...
%                 || pos(1) > odimX+padDimFirstHalf(1) || pos(2) > odimY+padDimFirstHalf(2) || pos(3) > odimZ+padDimFirstHalf(3)
%             continue;
%         end
        % compute PCA
